// Themed globe for the Contact section — brand green + Claude coral.
import { World } from './Globe'

// brand green, light green, coral
const colors = ['#008737', '#1f9c5c', '#d97757']
const pick = () => colors[Math.floor(Math.random() * colors.length)]

const globeConfig = {
  pointSize: 4,
  globeColor: '#04160d', // deep green-black
  showAtmosphere: true,
  atmosphereColor: '#52b788', // brand-300 green
  atmosphereAltitude: 0.1,
  emissive: '#04160d',
  emissiveIntensity: 0.12,
  shininess: 0.9,
  polygonColor: 'rgba(82,183,136,0.6)', // brand-300 hex dots
  ambientLight: '#52b788',
