...
export const Code = (p) => (
  <svg {...base} {...p}><path d="M16 18l6-6-6-6" /><path d="M8 6l-6 6 6 6" /></svg>
)
export const TrendingUp = (p) => (
  <svg {...base} {...p}><path d="M23 6l-9.5 9.5-5-5L1 18" /><path d="M17 6h6v6" /></svg>
)
export const Award = (p) => (
  <svg {...base} {...p}><circle cx="12" cy="8" r="6" /><path d="M8.7 13.2L7.5 22l4.5-2.7L16.5 22l-1.2-8.8" /></svg>
)
export const Scan = (p) => (
  <svg {...base} {...p}><path d="M3 7V5a2 2 0 012-2h2" /><path d="M17 3h2a2 2 0 012 2v2" /><path d="M21 17v2a2 2 0 01-2 2h-2" /><path d="M7 21H5a2 2 0 01-2-2v-2" /><path d="M7 12h10" /></svg>
)
export const Smartphone = (p) => (
  <svg {...base} {...p}><rect x="5" y="2" width="14" height="20" rx="2" /><path d="M12 18h.01" /></svg>
)
export const Users = (p) => (
  <svg {...base} {...p}><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87" /><path d="M16 3.13a4 4 0 010 7.75" /></svg>
)
export const Bell = (p) => (
